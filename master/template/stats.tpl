			...
			<script>
				...
				$(".search_button").click(function() {
					...
					location="/master.php?do=listpartner&option=edit&id={id}&datestart=" + datestart + "&dateend=" + dateend + "&sub1=" + sub1 + "&sub2=" + sub2 + "&sub3=" + sub3 + "&sub4=" + sub4 + "&sub5=" + sub5 + "&streams=" + streams;
				});
		...
		<div style="display: inline-block;">
				...
				<div style="width: 200px; margin: 8px 0px 0px 0px;" class="float">
					...
					<a href="/master.php?do=listpartner&option=ref&id={id}" class="search_button btn btn-primary btn-primaryNew" style="margin: 15px 0px 0px 0px; text-decoration: none; color: #c6c6c6; width: 144px;">Пользователи</a>
					
					<a href="/master.php?do=listpartner&option=setting&id={id}" class="search_button btn btn-primary btn-primaryNew" style="margin: 15px 0px 0px 0px; text-decoration: none; color: #c6c6c6; width: 144px;">Настройки</a>

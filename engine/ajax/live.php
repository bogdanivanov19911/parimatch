...
if($row[0] == "") {
				...
				while($row2 = $query2->fetch_assoc()) {
					...
					$events = "";
						...
						foreach($events_array[$row2["id"]] as $row3) {
							...
							if($c == 0) {
								$event->set('{score_all}', " <br /><span style='color:#ff0000'>Прием ставок приостановлен!</span>");
							} else {
		...
		$body = '<div class="page-wrapper">'.$game_line_block.$games.'</div>';
	}
